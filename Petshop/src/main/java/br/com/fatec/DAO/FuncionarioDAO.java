...
public class FuncionarioDAO {
    ...
    public Collection<Funcionario> lista(String criterio) throws Exception {
    ...
    public static void inserirFuncionariosPadroes() {
        ...
        Funcionario f1 = new Funcionario(FuncionarioDAO.idCount++, "Mario", "Recepcionista", "(11)99888-8888", "Mario@gmail", "123.111.222-33", "23.111.222-3", "25-10-2000", "23131-444");
